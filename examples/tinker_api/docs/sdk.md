...
```bash
python examples/tinker_api/run_recipe.py qwen_sft_quick --dry-run
python examples/tinker_api/run_recipe.py nemotron_sft_large --dry-run
python examples/tinker_api/run_recipe.py nemotron_rl_lora --dry-run
```
